        ...
        echo'<main>
			...
			<div class="gridframe">
				<div class="gridelem titre"><p>'.$var.'</p></div>
  				...
  				<div class="gridelem onglet"><p>Producer(s) : </p></div>
				...
				echo '</div>
  				<div class="gridelem onglet"><p>Year of release : </p></div>
  				<div class="gridelem  info"><p>'.$var2.'</p></div>
  				<div class="gridelem onglet"><p>Origin : </p></div>
				...
				echo '</div>
  				<div class="gridelem onglet"><p>Main actors : </p></div>
				<div class="gridelem info">';
				...
				echo '</div>
				<div class="gridelem synmenu onglet"><p>Plot : </p></div>
				<div class="gridelem syncontent"><p>'.$var6.'</p></div>
  				<div class="gridelem"></div>
				<div class="gridelem video"><video controls src="../ba/'.$var5.'">Please update your browser.</video></div>
				<div class="gridelem"></div>
  				<div class="gridelem"></div>
				<div class="gridelem"></div>
				<div class="gridelem"></div>
